...
class JwtToken:
    ...
    def _get_token(self, time_delta: timedelta):
    ...
    def access_token(self) -> str:
        return self._get_token(timedelta(days=self._access_token_expiration))

    @property
    def refresh_token(self) -> str:
        return self._get_token(timedelta(days=self._refresh_token_expiration))
